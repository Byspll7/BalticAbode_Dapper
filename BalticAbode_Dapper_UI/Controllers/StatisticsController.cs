...
namespace BalticAbode_Dapper_UI.Controllers
{
    public class StatisticsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage1 = await client1.GetAsync("https://localhost:44348/api/Statistics/ActiveEmployeeCount");
            ...
            var responseMessage2 = await client2.GetAsync("https://localhost:44348/api/Statistics/ApartmentCount");
            ...
            var responseMessage3 = await client3.GetAsync("https://localhost:44348/api/Statistics/AverageProductPriceByRent");
            ...
            ViewBag.avarageProductPriceBySale = jsonData4;
            #endregion

            #region AvarageRoomCount  
            var client5 = _httpClientFactory.CreateClient();
            var responseMessage5 = await client5.GetAsync("https://localhost:44348/api/Statistics/AvereageRoomCount");
            var jsonData5 = await responseMessage5.Content.ReadAsStringAsync();
            ViewBag.avarageRoomCount = jsonData5;
            #endregion

            #region CategoryCount  
            var client6 = _httpClientFactory.CreateClient();
            var responseMessage6 = await client6.GetAsync("https://localhost:44348/api/Statistics/CategoryCount");
            ...
            var responseMessage7 = await client7.GetAsync("https://localhost:44348/api/Statistics/CategoryNameByMaxProductCount");
            var jsonData7 = await responseMessage7.Content.ReadAsStringAsync();
            ViewBag.productCount = jsonData7;
            #endregion

            #region CityNameByMaxProductCount  
            var client8 = _httpClientFactory.CreateClient();
            var responseMessage8 = await client8.GetAsync("https://localhost:44348/api/Statistics/CityNameByMaxProductCount");
            ...
            var responseMessage11 = await client11.GetAsync("https://localhost:44348/api/Statistics/NewestBuildingYear");
            ...
            var responseMessage12 = await client12.GetAsync("https://localhost:44348/api/Statistics/OldestBuildingYear");
            ...
            var responseMessage13 = await client13.GetAsync("https://localhost:44348/api/Statistics/PassiveCategoryCount");
            ...
            var responseMessage14 = await client14.GetAsync("https://localhost:44348/api/Statistics/ProductCount");
